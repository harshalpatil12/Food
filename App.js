...
async function fetchData4mAPI(inpVal) {
  app_id = "0584fbb5";
  app_key = "f5ec79489efc04bff9b19f70284e2ca1";
    ...
    showINHTML += `
        ...
        <div class="card">
            <div class="card-body">
                ...
                <h6 class=' text-center my-2 text-truncate'>${
                  result.recipe.label
                }</h6>
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class=' align-self-stretch mx-auto my-auto'>Calories: ${result.recipe.calories.toFixed(
                      2
                    )}</h6>
                    <a href='${
                      result.recipe.url
                    }' class='btn btn-link align-self-stretch'>View Recipe</a>
                </div>
            </div>
        </div>
    </div> 
